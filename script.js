...
const themes = ['', 'light-theme', 'olive-theme'];
const themeIcons = ['🌙', '☀️', '🌿'];
let currentThemeIdx = 0;

themeBtn.textContent = themeIcons[currentThemeIdx];
themeBtn.onclick = () => {
...
function initFlashes() {
  ...
  for(let i=0; i<10; i++) {
    ...
    f.style.width = (Math.random() * 40 + 40) + 'px'; // 40-80px
